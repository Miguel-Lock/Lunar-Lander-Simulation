from constants import GRAVITY, MMOON, RMOON, FORCEOFTHRUST, SCREENWIDTH, SCREENHEIGHT, SURFACE, FONT, SCREEN, ROCKET_BOTTOM, VERTICAL_DISTANCE, FPS, METERPERPX, PXPERMETER, BASE_ROCKET_AND_FUEL, BASE_FUEL_AMT, TOTALVERTICALDISTANCE, BASE_ROCKET
import time
